...
export const metadata: Metadata = {
  ...
  keywords: [
    "imóveis de leilão em Palmas TO",
    "leilão de imóveis Palmas",
    "oportunidades de imóveis leilão",
    "imóveis abaixo do valor de mercado Palmas",
    "Pedro Soares leilões"
  ],
  alternates: {
...
export default async function ImoveisLeilaoPage({
  searchParams
}: {
  ...
  const filtered = properties.filter(
    (property) => property.purpose === "LEILAO" || property.isAuctionOpportunity || Boolean(property.auctionCase)
  );
  ...
  const collectionSchema = {
    ...
    description: "Listagem de imóveis de leilão com filtros por região, tipo e faixa de valor.",
    url: `${baseUrl}/imoveis/leilao`
  };
      ...
      <section className="section" style={{ paddingBottom: 24 }}>
        <div className="container wp-section-head">
          ...
          <h1 className="section-title" style={{ marginTop: 0 }}>
            Oportunidades para arrematar com margem
          </h1>
          <p className="section-subtitle text-card">
            Filtre por bairro, tipo e faixa de valor para avaliar imóveis de leilão com mais rapidez.
          </p>
          ...
          <form method="GET" className="card" style={{ padding: 16, marginBottom: 20 }}>
            <div className="form-grid">
              ...
              <div>
                ...
                <input id="district" name="district" defaultValue={district} placeholder="Taquaralto" />
              </div>
              <div>
          ...
          {filtered.length ? (
            ...
            <article className="card" style={{ padding: 16 }}>
              <p style={{ margin: 0, color: "var(--text-muted)" }}>
                Nenhum imóvel de leilão encontrado com os filtros atuais. Ajuste os critérios e tente novamente.
              </p>
            </article>
          )}
        </div>
